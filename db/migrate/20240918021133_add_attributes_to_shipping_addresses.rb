class AddAttributesToShippingAddresses < ActiveRecord::Migration[7.0]
  def change
    ...
    #add_column :shipping_addresses, :addresses, :string
    #add_column :shipping_addresses, :house_number, :string
